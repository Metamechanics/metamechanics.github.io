...
- ## Purpose of this document
  collapsed:: true
	...
	- The role of Claude AI with respect to this document and the mission-vision is
		...
		- Prompt engineering trainer. Please provide feedback to improve my prompts so that we can produce better quality work more efficiently and iterate faster.
- ## Developer Profile
  collapsed:: true
	- ### Experience Level
	  collapsed:: true
...
- ## Current Writing and Development Approach
  collapsed:: true
	- Documentation: Logseq for quick capture, Obsidian for long-form but this is open to revision and suggestion.
	...
	- Claude Artifacts
	  collapsed:: true
		...
		- Let's create a library of artifacts that build on each other, refer to each other as helpful, updating as required.
	- Iterative
	  collapsed:: true
  ...
  collapsed:: true
	...
	- ### Phase 1:
	  collapsed:: true
		...
		- Core projects and apps developed to the point where it can be shared with circle of insider critical friends. I want my family and select friends to know and understand what I do, what I spend my time on, and see enough of certain projects to get a sense of them.
